...
from LAB1.models.model import get_gallery_model,Identity
from sklearn.model_selection import train_test_split
from utils.misc import *
from progress.bar import Bar
from LAB1.utils.reader import WeatherDataset, make_weights_for_balanced_classes
import pandas as pd
...
def main():
    ...
    if configs.resume:
        ...
        if not os.path.exists('query_CME.json'):
            ...
            df = pd.DataFrame({'query':output_list,
                               'query_incident':incident_list,
                               'query_image':image_name_list})
